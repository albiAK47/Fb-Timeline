...
const edit_data = document.getElementById("post-update-form");
  ...
  if (posts) {
    ...
    posts.reverse().forEach((item, index) => {
      ...
      <div class="user-post-header">
        ...
        <div class="dtn_two">
        <button data-bs-toggle="modal" data-bs-target="#post-update" onclick="editData('${
          item.id
...
const editData = (id) => {
  ...
  edit_data.querySelector('input[placeholder="Name"]').value = name;
  edit_data.querySelector('input[placeholder="Photo"]').value = photo;
  edit_data.querySelector('textarea[placeholder="Post"]').value = post;
  edit_data.querySelector('input[placeholder="Post Photo"]').value = post_photo;
  edit_data.querySelector('input[placeholder="ID"]').value = id;
};
